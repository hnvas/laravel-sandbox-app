...
<head>
    ...
    <noscript>
        <link rel="stylesheet" href="{{ asset('site/css/noscript.css') }}"/>
    </noscript>
</head>
...
<div id="wrapper">
    ...
    <div id="main">
        ...
        <article id="intro">
            ...
            <span class="image main"><img src="{{ asset('site/images/pic01.jpg') }}" alt=""/></span>
            <p>Aenean ornare velit lacus, ac varius enim ullamcorper eu. Proin
                ...
                euismod egestas. By the way, check out my <a href="#work">awesome
                    work</a>.</p>
        ...
        <article id="work">
            ...
            <span class="image main"><img src="{{ asset('site/images/pic02.jpg') }}" alt=""/></span>
            ...
            <p>Nullam et orci eu lorem consequat tincidunt vivamus et sagittis
        ...
        <article id="about">
            ...
            <span class="image main"><img src="{{ asset('site/images/pic03.jpg') }}" alt=""/></span>
            <p>Lorem ipsum dolor sit amet, consectetur et adipiscing elit.
                ...
                primis in faucibus. Cras viverra ligula sit amet ex mollis
                mattis lorem ipsum dolor sit amet.</p>
        </article>
        ...
        <article id="elements">
            ...
            <section>
                ...
                <blockquote>Fringilla nisl. Donec accumsan interdum nisi, quis
                    ...
                    eu felis iaculis volutpat ac adipiscing accumsan faucibus.
...
print 'It took ' + i + ' iterations to sort the deck.';</code></pre>
            ...
            <section>
                ...
                <ul class="actions">
                    <li><a href="#"
                           class="button primary icon fa-download">Icon</a></li>
                    <li><a href="#" class="button icon fa-download">Icon</a>
                    </li>
                </ul>
                <ul class="actions">
                    <li><span class="button primary disabled">Disabled</span>
                    </li>
    ...
    <!-- Footer -->
    <footer id="footer">
        <p class="copyright">&copy; Henrique Vasconcelos. Design: <a
...
<script src="{{ asset('site/js/browser.min.js') }}"></script>
<script src="{{ asset('site/js/breakpoints.min.js') }}"></script>
